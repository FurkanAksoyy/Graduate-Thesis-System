# Generated by Django 5.0.7 on 2024-12-31 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
                'db_table': 'Author',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Cosupervisor',
            fields=[
                ('cosup_id', models.AutoField(primary_key=True, serialize=False)),
                ('cosup_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
                'db_table': 'Institute',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keyword_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
                'db_table': 'Keyword',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=100)),
            ],
            options={
                'db_table': 'Language',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supervisor_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
                'db_table': 'Supervisor',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Thesis',
            fields=[
                ('thesis_no', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=100)),
            ],
            options={
                'db_table': 'Type',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('university_name', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=200)),
            ],
            options={
                'db_table': 'University',
                'managed': False,
